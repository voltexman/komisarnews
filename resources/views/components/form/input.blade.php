        ...
        <div class="relative grow">
            ...
            <input id="floating_filled"
                {{ $attributes->class([
                        ...
                        'peer block w-full rounded-lg border p-4 pt-6 pb-2 text-sm placeholder:text-transparent 
                        focus:border-max-soft focus:ring-max-soft 
            ...
            <label for="floating_filled" @class([
                'absolute left-2.5 top-4 z-10 origin-[0] scale-75 transform text-sm duration-300 
                                                                         peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 
                                                                         peer-focus:scale-75 peer-focus:-translate-y-4',
                'pl-12' => isset($icon),
                'text-max-dark peer-focus:text-max-dark peer-[:not(:placeholder-shown)]:text-max-dark' =>
                    $color === 'light',
                'text-max-text peer-focus:text-max-text peer-[:not(:placeholder-shown)]:text-max-text' =>
                    $color === 'dark',
            ])>
                Floating filled
            </label>
