    ...
    @else
        <div class="max-w-6xl mx-auto flex flex-col gap-y-16">
            @foreach ($posts as $post)
                <article
                    class="flex flex-col lg:flex-row gap-5 lg:gap-10 border-b border-max-orange/15 pb-15 last:border-b-0 last:pb-0">
                    <div class="flex-none max-w-12 flex flex-col gap-y-1.5">
                        ...
                        <div class="font-[Oswald] text-5xl font-bold text-black/60">
